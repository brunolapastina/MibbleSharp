// <copyright file="SnmpObjectIdentity.cs" company="None">
//    <para>
...
namespace MibbleSharp.Snmp
{
   ...
   /// <summary>
   /// The SNMP object identity type macro. This macro type was added to
   ...
   public class SnmpObjectIdentity : SnmpType
   {
      ...
      /// <summary>
      /// Gets the object identity status.
      /// </summary>
      ...
      /// <summary>
      /// Gets the object identity reference.
      /// </summary>

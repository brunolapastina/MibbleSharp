...
namespace MibbleSharp.Type
{
   ...
   public class ValueRangeConstraint : IConstraint
   {
      ...
      /// </summary>
      private readonly NumberValue lower;

      /// <summary>
      /// /The upper bound value.
      /// </summary>
      private readonly NumberValue upper;

      /// <summary>
      /// The strict lower bound flag.
      /// </summary>
      private readonly bool strictLower;

      /// <summary>
      /// The strict upper bound flag.
      /// </summary>
      private readonly bool strictUpper;
          ...
          MibValue value2)
      {
         ...
         if (value1 is StringValue s1 && value2 is StringValue s2)
         {
            return this.IsLessThan(strict, s1.ToString(), s2.ToString());
         }
         else
         {
            return false;
